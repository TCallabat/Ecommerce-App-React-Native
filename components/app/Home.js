...
class Home extends Component {
    ...
    componentDidMount() {
        fetch("http://192.168.1.21:8080")
            ...
            .then(
                (data) => this.setState({ data: data.filter(function (data) { return data.filter === "home1"; }) }),
    ...
    render() {
        return (
            <View style={{ flex: 1, backgroundColor: "lightgrey" }}>
                <View>
                    <Text style={{ height: 45, backgroundColor: "cadetblue", textAlign: "center", textAlignVertical: "center", color: "white", fontSize: 30, fontWeight: "600", letterSpacing: 2 }}>Amazon Pas Cher</Text>
                    <Image style={{ height: 175, width: "100%", resizeMode: "contain" }} source={require("../img/samsung-galaxy-s10-s10-1000x400.jpg")} />
                </View>
